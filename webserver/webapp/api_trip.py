                ...
                'products': [
                    {
                        ...
                        'home_price': 'Not available' if home_price is None else int(home_price),
                        'savings': 'Not available' if home_price is None else int(((float(home_price) - float(product.price)) / float(home_price)) * 100),
                        'link': product.link,
                    }
